...
ROOT_FILES_TO_LINK = {
    ...
    "Writing": "Writing",
    "STATE_PANEL.md": "root/STATE_PANEL.md",
    "HOT_PACK.md": "root/HOT_PACK.md",
    "OBJECT_INDEX.md": "root/OBJECT_INDEX.md",
    "PLAYER_PROFILE.md": "root/PLAYER_PROFILE.md",
    "GOVERNANCE_PANEL.md": "root/GOVERNANCE_PANEL.md",
    ".DM_SECRETS.md": "root/.DM_SECRETS.md",
    ".DM_PLANNER.md": "root/.DM_PLANNER.md",
}
...
def write_current_campaign(root: Path, rel_path: str) -> None:
    (root / "CURRENT_CAMPAIGN.md").write_text(rel_path.strip() + "\n", encoding="utf-8")
...
def validate_campaign_layout(campaign_dir: Path) -> None:
    required = [
        ...
        campaign_dir / "root" / "STATE_PANEL.md",
...
def cmd_init(args: argparse.Namespace) -> None:
    ...
    if not current_rel:
        raise RuntimeError("CURRENT_CAMPAIGN.md is empty; run campaign_manager.py switch/new first")
    ...
    profile_path = campaign_dir / "root" / "PLAYER_PROFILE.md"
    ...
    state_path = campaign_dir / "root" / "STATE_PANEL.md"
    ...
    hot_path = campaign_dir / "root" / "HOT_PACK.md"
...
def cmd_switch(args: argparse.Namespace) -> None:
    ...
    # Update symlinks first; pointer file last (so a partial failure doesn't lie).
    for link_name, target_rel in ROOT_FILES_TO_LINK.items():
        replace_symlink(root / link_name, Path(rel) / target_rel)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description="Create/switch/init campaigns by copying a template and updating root symlinks + CURRENT_CAMPAIGN.md",
    )
