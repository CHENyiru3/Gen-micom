# CLI_SPEC.md — Mist Frontier: Player Command-Line Input Spec
...
| `[Inner]{Emotion}` | Emotional fluctuations: attraction/intimacy/shame/jealousty/longing/loss |
...
*CLI_SPEC.md v2.0 - Chronicle of the Mist Frontier: Flux*
