...
- HOT: `campaigns/<id>/STATE_PANEL.json`, latest `campaigns/<id>/sessions/session_*.md`, `campaigns/<id>/quests/QUEST_LOG.md`, `cartridges/<id>/locations/LOCATION_INDEX.md`, `campaigns/<id>/characters/PCs/*`
...
`campaigns/<id>/sessions/` > state snapshots (`campaigns/<id>/STATE_PANEL.json` / `campaigns/<id>/index.md` / `campaigns/<id>/WORLD_STATE.md`) > object files (`cartridges/<id>/characters/` / `cartridges/<id>/quests/` / `cartridges/<id>/locations/`) > lore (`cartridges/<id>/lore/CANON`, `cartridges/<id>/lore/MIST`) > fiction (`campaigns/<id>/Writing/`).
