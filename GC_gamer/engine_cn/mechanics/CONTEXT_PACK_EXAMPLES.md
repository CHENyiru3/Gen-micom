...
> **用途**：示例与历史兼容；规范以 `engine/mechanics/CONTEXT_PACK.md` 为准。  
...
- 战斗：`engine/mechanics/COMBAT.md`
- 社交/调查：`engine/mechanics/SOCIAL_INVESTIGATION.md`
- 生存：`engine/mechanics/SURVIVAL.md`
